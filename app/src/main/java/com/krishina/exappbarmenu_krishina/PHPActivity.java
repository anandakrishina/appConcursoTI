...
public class PHPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        perguntas = getResources().getStringArray(R.array.perguntasPHP);
        explicacoes = getResources().getStringArray(R.array.explicacaoPHP);
        respostasCorretas = getResources().getIntArray(R.array.respostaCorretaPHP);

        opcoes = new String[][]{
                getResources().getStringArray(R.array.opcao0PHP),
                getResources().getStringArray(R.array.opcao1PHP),
                getResources().getStringArray(R.array.opcao2PHP),
        };
            ...
            public void onClick(View view) {
                ...
                if (idBotaoSelecionado != -1) {
                    ...
                    if(verificaAcerto.verificarAcerto(indexRespostaSelecionada,respostasCorretas[index]) == 1){
                        textViewExplicacao.setBackgroundColor(ContextCompat.getColor(PHPActivity.this,R.color.acertoCor));
                    } else {
                        textViewExplicacao.setBackgroundColor(ContextCompat.getColor(PHPActivity.this,R.color.erroCor));
                    }
    ...
    private void mostrarResultado() {
        ...
        textViewPergunta.setBackgroundColor(ContextCompat.getColor(PHPActivity.this,R.color.acertoCor));
